...
int sumSection1(int d1, int d2, int x, int y) {
	int start = 0;
	int nowSum = 0;
	for (int j = 1; j < y; j++) {
		if (y - d1 <= j)start++;
...
int sumSection2(int d1, int d2, int x, int y) {
	int start = 0;
	int nowSum = 0;
	for (int j = y; j <= N; j++) {
...
int sumSection3(int d1, int d2, int x, int y) {
	int start = 1;
	int nowSum = 0;
...
int sumSection4(int d1, int d2, int x, int y) {
	int start = 0;
	int nowSum = 0;
...
void checkDiv(int d1, int d2, int x, int y) {
